package org.erick.telemetrydlqservice.dto;
...
@Schema(description = "API representation of a telemetry message that reached the dead-letter queue.")
public class TelemetryDlqRecordDto {
